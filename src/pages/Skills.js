          ...
          <Row>
            ...
            >
              <Card className="bg-secondary rounded-3 shadow h-100 justify-content-between ">
                ...
                <Card.Body>
                  <Card.Text>
                    I am experienced in using popular web frameworks from
                    Next.js for front-end, to Django for developing backend.
                    With these skills, I can create visually appealing and
                    interactive websites and web applications, as well as work
                    with databases.
                  </Card.Text>
                </Card.Body>
              ...
              <Card className="bg-success rounded-3 shadow-sm h-100 d-flex justify-content-between">
                ...
                <Card.Body>
                  <Card.Text className="text-justify display-8">
                    ...
                    issues. I am also able to work collaboratively with others
                    to brainstorm ideas and develop strategies for overcoming
                    obstacles.
                  </Card.Text>
                </Card.Body>
              </Card>
              ...
              <Card className="bg-secondary rounded-3 shadow h-100 justify-content-between">
                ...
                <Card.Body>
                  <Card.Text className="text-justify">
                    I am experienced with wide variety of software tools, some
                    of which are Visual Studio, GitHub, Access Databases and
                    Git. I am able to appropriately find the right tools
                    required for the proper execution of specific tasks.
                  </Card.Text>
                </Card.Body>
                <Card.Body className="px-0">
                  <Carousel
